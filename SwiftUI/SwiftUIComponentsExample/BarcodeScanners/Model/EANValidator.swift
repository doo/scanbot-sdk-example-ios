...
/**
 ...
 Implements the SBSDKContentValidationCallback protocol, providing validation and cleanup of scanned
 text for use in barcode and text pattern recognition workflows.
 Ensures only valid, properly checksummed EAN codes are accepted.
 */
final class EANValidator: NSObject, SBSDKContentValidationCallback {
