//
//  DocumentDataExtractorLocalizationUI2SwiftUIView.swift
//  ScanbotSDK Examples
//
...
struct DocumentDataExtractorLocalizationUI2SwiftUIView: View {
...
#Preview {
    DocumentDataExtractorLocalizationUI2SwiftUIView()
}
