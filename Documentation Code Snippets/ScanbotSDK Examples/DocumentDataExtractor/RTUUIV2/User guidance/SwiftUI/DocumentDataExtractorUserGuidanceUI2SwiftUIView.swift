//
//  DocumentDataExtractorUserGuidanceUI2SwiftUIView.swift
//  ScanbotSDK Examples
//
...
struct DocumentDataExtractorUserGuidanceUI2SwiftUIView: View {
...
#Preview {
    DocumentDataExtractorUserGuidanceUI2SwiftUIView()
}
