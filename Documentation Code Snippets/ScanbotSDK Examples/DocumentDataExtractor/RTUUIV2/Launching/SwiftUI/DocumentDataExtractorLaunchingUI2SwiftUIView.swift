//
//  DocumentDataExtractorLaunchingUI2SwiftUIView.swift
//  ScanbotSDK Examples
//
...
struct DocumentDataExtractorLaunchingUI2SwiftUIView: View {
...
#Preview {
    DocumentDataExtractorLaunchingUI2SwiftUIView()
}
