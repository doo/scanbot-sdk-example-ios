//
//  BarcodeImageResultHandlingSwiftUIView.swift
//  ScanbotSDK Examples
//
...
struct BarcodeImageResultHandlingSwiftUIView: View {
    ...
    func runScanner() {
        ...
        do {
            ...
            resultText = "Barcodes scanned: \(result.barcodes.count)"
        }
        catch {
            resultText = "Error running barcode scanner: \(error.localizedDescription)"
...
#Preview {
    BarcodeImageResultHandlingSwiftUIView()
}
