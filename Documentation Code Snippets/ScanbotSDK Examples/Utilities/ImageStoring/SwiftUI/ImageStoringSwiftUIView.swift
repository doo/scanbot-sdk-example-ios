...
struct ImageStoringSwiftUIView: View {
    
    var body: some View {
        VStack {
            Button("Create Indexed Image Storage") {
                createIndexedImageStorage()
            }
            Button("Basic Operations On Indexed Image Storage") {
                basicOperationsOnIndexedImageStorage()
            }
            Button("Basic Operations On Keyed Image Storage") {
                basicOperationsOnKeyedImageStorage()
            }
        }
    }
    ...
    func createIndexedImageStorage() {
        ...
        // Create a storage location object. This will create the folder on the filesystem if necessary.
