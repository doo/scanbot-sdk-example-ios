//
//  ImageMetadataProcessorSwiftUIView.swift
//  ScanbotSDK Examples
//
...
struct ImageMetadataProcessorSwiftUIView: View {
    
    var body: some View {
        Text("Image Metadata Processor")
            .task {
                processImageMetadata()
            }
    }
    
    func processImageMetadata() {
...
#Preview {
    ImageMetadataProcessorSwiftUIView()
}
