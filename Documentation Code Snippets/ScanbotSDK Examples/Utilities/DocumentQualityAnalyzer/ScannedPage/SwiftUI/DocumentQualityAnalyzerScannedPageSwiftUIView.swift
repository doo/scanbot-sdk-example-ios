//
//  DocumentQualityAnalyzerScannedPageSwiftUIView.swift
//  ScanbotSDK Examples
//
...
struct DocumentQualityAnalyzerScannedPageSwiftUIView: View {
    
    var body: some View {
        Text("Document Quality Analyzer")
            .task {
                do {
...
#Preview {
    DocumentQualityAnalyzerScannedPageSwiftUIView()
}
